...
namespace Try4Real.Client.Wpf.RemoteDataAccess
{
    public class CustomerServiceClient : ClientBase<ICustomerService>, ICustomerService
    {
        ...
        public IEnumerable<CustomerListItem> GetCustomerListItems() => Channel.GetCustomerListItems();
        ...
        public CustomerDetails GetCustomerDetails(Guid customerId) => Channel.GetCustomerDetails(customerId);
